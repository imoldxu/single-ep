...
//   }
//   
//   public Patient getDiagnosis(String type, String number) throws Exception{
//	   String sqlwhere = "<type>"+type+"</type><num>"+number+"</num>"; //1806190791
//	   String xml = ReturnXml("bianm.get.byMZH", sqlwhere);
//	   Patient ret = xml2Diagnosis(number, xml);
//	   return ret;
//   }
//   
//   
//   private Patient xml2Diagnosis(String number, String xml) throws Exception{
